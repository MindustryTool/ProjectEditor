...
value: unknown}},category them by thier usage and visibleWhen for boolean flag if needed, use translation key with "editor." prefix and only use \[a-z0-9-.] and update en/translation.ts, java source code bellow: 
