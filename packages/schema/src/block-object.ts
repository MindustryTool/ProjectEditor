	...
	v.lazy((data) => {
		...
		return v.object({
			...
			offset: v.pipe(
				...
				metadata({ name: "editor.block.offset", description: "editor.block.offset-description" }),
			),
			sizeOffset: v.pipe(
				v.optional(v.number(), 0),
				metadata({
			...
			variantRegions: ArrayTextureSchema("@#", variants, false),
            variantShadowRegions: ArrayTextureSchema("@-shadow#", variants, false),
			drawArrow: v.pipe(
				v.optional(v.boolean(), true),
				metadata({
			...
			albedo: v.pipe(
				v.optional(v.number(), 0),
				metadata({ name: "editor.block.albedo", description: "editor.block.albedo-description" }),
			),
			emitLight: v.pipe(
				v.optional(v.boolean(), false),
				metadata({
			...
			health: v.pipe(
				v.optional(v.number(), -1),
				metadata({ name: "editor.block.health", description: "editor.block.health-description" }),
			),
			scaledHealth: v.pipe(
				v.optional(v.number(), -1),
				metadata({
			...
			solid: v.pipe(
				v.optional(v.boolean(), false),
				metadata({ name: "editor.block.solid", description: "editor.block.solid-description" }),
			),
			solidifes: v.pipe(
				v.optional(v.boolean(), false),
			...
			sync: v.pipe(
				v.optional(v.boolean(), false),
				metadata({ name: "editor.block.sync", description: "editor.block.sync-description" }),
			),
			// Combat & Targeting
			attacks: v.pipe(
				v.optional(v.boolean(), false),
			...
			timers: v.pipe(
				v.optional(v.number(), 0),
				metadata({ name: "editor.block.timers", description: "editor.block.timers-description" }),
			),
			fogRadius: v.pipe(
				v.optional(v.number(), -1),
				metadata({
