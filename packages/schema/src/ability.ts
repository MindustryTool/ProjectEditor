...
export const AbilityHjsonSchema = new ClassMap<AbilityClass>({
	Ability: () => ({}),
	ArmorPlateAbility: (_context) => armorPlateAbilityObjectSchema.entries,
	EmptyDataAbility: (_context) => ({}),
	...
	ForceFieldAbility: (context) => forceFieldAbilityObjectSchema(context).entries,
	...
	RegenAbility: (_context) => regenAbilityObjectSchema.entries,
