...
export const jsonProjectTree = new DefaultProjectFileTree([
	{
		...
		children: [
			...
			{ name: "status", type: "folder", path: "content/status" },
			{ name: "effects", type: "folder", path: "content/effects" },
			{ name: "weathers", type: "folder", path: "content/weathers" },
			{ name: "sectors", type: "folder", path: "content/sectors" },
			{ name: "planets", type: "folder", path: "content/planets" },
		],
	},
