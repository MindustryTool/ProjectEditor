...
function FormControl({ className, ...props }: React.ComponentProps<"div">) {
	return <div data-slot="form-control" className={cn("[&>input]:w-full [&>select]:w-full", className)} {...props} />;
}
...
function FormMessage({ className, ...props }: React.ComponentProps<"p">) {
	return <p data-slot="form-message" className={cn("text-xs text-destructive", className)} {...props} />;
}
