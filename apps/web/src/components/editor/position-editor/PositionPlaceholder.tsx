...
function useDragHandling(initX: number, initY: number, onDrag?: DragHandler) {
...
export function EnginePositionPlaceholder({
	...
	return (
		...
		>
			...
			<Arc
				angle={region.rotation.value}
				innerRadius={0}
				outerRadius={Math.max(r, 16)}
				fill="#fef08a"
				opacity={0.5}
			/>
			<Text text="engine" fontSize={9} fill="#713f12" width={40} height={16} offsetX={20} offsetY={8} align="center" verticalAlign="middle" />
		</Group>
	);
}
