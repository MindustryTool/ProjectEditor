...
export function TreeNodeActions({ currentPath, depth, isFolder, isSelected, onContextMenu }: TreeNodeActionsProps) {
	...
	return (
		<div className={cn("flex items-center gap-0.5 ml-auto", !isSelected && "md:invisible group-hover:visible", isSelected && "visible")}>
			{isFolder && (
				<button onClick={handleCreateClick} className="flex size-6 items-center justify-center rounded hover:bg-accent" title="Create">
